    ...
    slide_1: [
      {
        ...
        description: [
          "According to the United Nations there are more than 8.0 billion people on earth. Of these, about 56% live on urban areas, which represent only 1% of habitable land. Therefore, in general, humanity lives in tight spaces, which demand high amounts of resources.",
        ],
      },
      {
        type: 4,
        ...
        title: "Carbon",
        description: [
          "Resources demand energy, which often is generated by fossil fuels. Due to this fact, cities are responsible for 70% of CO2 emissions. Carbon dioxide is a greenhouse gas, which means, it traps heat in the earth.",
          "Since the 18th century, human activities have increased atmospheric CO2 levels by 50%, far surpassing the natural rise that occurred after the last ice age.",
        ],
      },
      {
        type: 2,
    ...
    slide_2: [
      {
        ...
        title: "Our world in on fire",
        description: [
          "As shown by the Sentinel-3 World Fire Atlas, developed by the European Space Agency, the amount of Wildfires has been increasing over the recent years, reaching a new peek in 2024.",
        ],
      },
      {
        type: 3,
      ...
      },
      {
        ...
        graphs: [],
        title: "Identifying WildFires",
        description: [
          "There are many ways to identify Wildfires, such as Air patrols, Infrared technology and Satellites. With the later, active fires are identified by comparing the temperature of a potential fire with its surroundings and check if the difference exceeds a set threshold."
        ],
      },
      {
        type: 2,
        ...
        description: [
          "The smoke generated from fires can be carried by wind currents and reach really far places. The smoke from Canada wildfires, for instance, has spread all the way to Europe. In South America, smoke from Brazil has spread through the country and reached Argentina and Uruguay."
        ],
      },
      {
        type: 3,
